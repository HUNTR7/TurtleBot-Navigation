...
class sim_nav_goals():
    def __init__(self):
        ...
        rospy.Subscriber('yolov5/detections', BoundingBoxes, self.bb_info, queue_size=10)
        ...
        while not rospy.is_shutdown():            
            ...
            if self.counter % 2 == 0:
                # First pose
                theta = 1.5708  # Orientation angle
    ...
    def bb_info(self, msg):
        self.display_detections(msg)

    def display_detections(self, msg):
        for bb in msg.bounding_boxes:
            rospy.loginfo("Detected object '{}' at position ({}, {}) with size ({}, {})".format(bb.Class, bb.xmin, bb.ymin, bb.xmax, bb.ymax))
